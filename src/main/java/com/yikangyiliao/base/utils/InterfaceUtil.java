...
public class InterfaceUtil {
	...
	static {
		 ...
		 * @desc 注册用户
		 */
		// serviceClassName.put("insertRegisterUserForThreepart",
		// "userService");
		...
		// serviceClassName.put("registerUserAndSaveServiceInfo",
		// "userService");
		// mathodClassPath.put("registerUserAndSaveServiceInfo",
		// "saveRegisterUserAndSaveServiceInfo");
		...
		// mathodClassPath.put("00-21-03",
		// "addPointmentOrderAndSubmitAssessment");
		// // 查询我的工作日程
		// mathodClassPath.put("00-21-04",
		// "getServicerScheduleByServiceUserId");
		// //查询我的工作日程详情
		 ...
		 * 
		 * @author bry
		 * @date 2016-10-10 16:32
		 * @desc 添加举报信息 00-47
		 */
		YiKangServiceConfige addReportInformation = new YiKangServiceConfige();
		addReportInformation.setServiceName("reportInfomationService");
		addReportInformation.setMethodName("addReportInformation");
	...
	/**
	 * @author liushuaic
	 * @date 2015/11/26 11:06 获取method config
	 * 
	 **/
